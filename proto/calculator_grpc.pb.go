...
func (c *calculatorServiceClient) PrimeNumbers(ctx context.Context, in *PrimeNumbersRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumbersClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/calculatorService/PrimeNumbers", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculatorServiceClient) FindMaxNumber(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_FindMaxNumberClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[2], "/calculatorService/FindMaxNumber", opts...)
	if err != nil {
		return nil, err
	}
...
type CalculatorService_FindMaxNumberClient interface {
	Send(*FindMaxAverageRequest) error
	Recv() (*FindMaxAverageResponse, error)
	grpc.ClientStream
}
...
func (x *calculatorServiceFindMaxNumberClient) Send(m *FindMaxAverageRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxNumberClient) Recv() (*FindMaxAverageResponse, error) {
	m := new(FindMaxAverageResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type CalculatorService_FindMaxNumberServer interface {
	Send(*FindMaxAverageResponse) error
	Recv() (*FindMaxAverageRequest, error)
	grpc.ServerStream
}
...
func (x *calculatorServiceFindMaxNumberServer) Send(m *FindMaxAverageResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxNumberServer) Recv() (*FindMaxAverageRequest, error) {
	m := new(FindMaxAverageRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
